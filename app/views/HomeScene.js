  ...
  render () {
    return (
      <View>
        ...
        <ScrollView height={vh-126} style={styles.container} automaticallyAdjustContentInsets={false}>
        <View>

        <Swiper style={{height:vh/5}}>
            <View><Image style={[styles.scrollimg,{height:vh/5}]} width={vw} source={require('../images/scrollimgs1.png')}/></View>
            <View><Image style={[styles.scrollimg,{height:vh/5}]} source={require('../images/scrollimgs2.png')}/></View>
            <View><Image style={[styles.scrollimg,{height:vh/5}]}   source={require('../images/scrollimgs3.png')}/></View>
          </Swiper>
        </View>
          ...
          <View style={styles.mainWrapper}>
            <View style={[styles.title,{marginTop: 13}]}>
              ...
              <View style={{height:15}}><Text style={{paddingLeft:6,fontSize:15}}>正在讨论</Text></View>
            </View>
            ...
            <View style={styles.row}>
              <TouchableOpacity style={styles.sytt} 
              onPress={() => {
            ...
            <View style={[styles.title,{marginBottom:10,marginTop: 4}]}>
              <View style={styles.square}></View>
               <View style={{height:15}}><Text style={{paddingLeft:6,fontSize:15}}>本地热门</Text></View>
              </View>
            <View>
